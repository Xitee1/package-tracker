  ...
  <div class="p-6 max-w-7xl mx-auto">
    ...
    <div class="bg-white dark:bg-gray-900 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
      <div class="px-5 py-4 border-b border-gray-200 dark:border-gray-700 flex items-center justify-between">
        ...
        <router-link to="/orders" class="text-sm text-blue-600 hover:text-blue-500 dark:text-blue-400 dark:hover:text-blue-300">
          View all
        </router-link>
      </div>
      ...
      <div v-else-if="recentOrders.length === 0" class="p-8 text-center text-gray-500 dark:text-gray-400">
          ...
          <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
            ...
            >
              <td class="px-5 py-3">
                ...
                <div v-if="order.tracking_number && order.order_number" class="text-xs text-gray-500 dark:text-gray-400">
...
const statusCounts = computed(() => {
  ...
  for (const order of ordersStore.orders) {
    ...
    else if (order.status === 'in_transit' || order.status === 'out_for_delivery') counts.in_transit++
