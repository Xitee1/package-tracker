  ...
  <div class="p-6 max-w-4xl mx-auto">
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200">
      ...
      <div v-else-if="error" class="p-4">
        <div class="bg-red-50 border border-red-200 text-red-700 px-4 py-3 rounded-md text-sm">{{ error }}</div>
      </div>
            ...
            <tr v-for="user in users" :key="user.id" class="hover:bg-gray-50">
              ...
              <td class="px-5 py-3">
                <span
                  ...
                  :class="user.is_admin ? 'bg-purple-100 text-purple-800' : 'bg-gray-100 text-gray-700'"
                >
              ...
              <td class="px-5 py-3 text-right">
                <div class="flex items-center justify-end gap-2">
                  ...
                  <button
                    ...
                    :disabled="auth.user?.id === user.id"
                    class="px-3 py-1.5 text-xs font-medium text-red-700 bg-white border border-red-300 rounded-md hover:bg-red-50 disabled:opacity-40 disabled:cursor-not-allowed"
                  >
                    Delete
                  </button>
                </div>
