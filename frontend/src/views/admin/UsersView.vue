<template>
  <div class="p-6 max-w-4xl mx-auto">
    ...
    <div v-if="showForm" class="bg-white dark:bg-gray-900 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6 mb-6">
      ...
      <form @submit.prevent="handleCreateUser" class="space-y-4">
        ...
        <div class="flex items-center gap-2">
          ...
          />
          <label for="is_admin" class="text-sm font-medium text-gray-700 dark:text-gray-300">Admin privileges</label>
        </div>
    ...
    <div class="bg-white dark:bg-gray-900 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
      <div v-if="loading" class="p-8 text-center text-gray-500 dark:text-gray-400">Loading users...</div>

      <div v-else-if="error" class="p-4">
        <div class="bg-red-50 dark:bg-red-900/30 border border-red-200 dark:border-red-800 text-red-700 dark:text-red-400 px-4 py-3 rounded-md text-sm">{{ error }}</div>
      </div>
            ...
            <tr v-for="user in users" :key="user.id" class="hover:bg-gray-50 dark:hover:bg-gray-800">
              ...
              <td class="px-5 py-3">
                <span
                  ...
                  :class="user.is_admin ? 'bg-purple-100 dark:bg-purple-900/40 text-purple-800 dark:text-purple-300' : 'bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300'"
                >
