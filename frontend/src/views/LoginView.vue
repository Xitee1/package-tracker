<template>
  <div class="min-h-screen relative bg-gray-50 dark:bg-gray-950">
    <!-- Language switcher -->
        ...
        <div class="bg-white dark:bg-gray-900 rounded-lg shadow-md p-8">
          ...
          <form @submit.prevent="handleSetup" class="space-y-5">
            ...
            <button
              type="submit"
              :disabled="loading"
              class="w-full flex justify-center py-2.5 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-600 hover:not-disabled:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:opacity-50 disabled:cursor-not-allowed"
            >
