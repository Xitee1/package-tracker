...
async def create_account_and_folder(client, token):
    account = await client.post("/api/v1/providers/email-user/accounts", json={
    ...
    folder = await client.post(f"/api/v1/providers/email-user/accounts/{account_id}/folders/watched",
...
async def test_patch_watched_folder_overrides(client, admin_token):
    ...
    resp = await client.patch(f"/api/v1/providers/email-user/accounts/{account_id}/folders/watched/{folder_id}",
