...
Revision ID: 9299dae441a6
Revises: 
Create Date: 2026-02-13 21:42:00.927368
...
def upgrade() -> None:
    ...
    sa.Column('source_email_message_id', sa.String(length=512), nullable=True),
